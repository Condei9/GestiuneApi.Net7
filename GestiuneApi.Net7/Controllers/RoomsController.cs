...
namespace GestiuneSaliNET7.Controllers
{
    ...
    public class RoomsController : Controller
    {
        ...
        [HttpGet("search")]
        public async Task<IActionResult> getRoomsByType([FromQuery] bool isLab)
        {
            if (isLab == null || _context.Rooms == null)
            {
                return NotFound(StatusCode(404));
            }

            var roomModel = await _context.Rooms.Where(x => x.labRoom == isLab).ToListAsync();
